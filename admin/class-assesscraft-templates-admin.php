...
final class AssessCraft_Templates_Admin {
	...
	public function render(): void {
		...
		<div class="wrap ac-template-page">
			...
			<div class="ac-import-card ac-unified-import<?php echo AssessCraft_Features::available( 'json_portability' ) ? '' : ' ac-pro-locked'; ?>">
				...
				</form><?php else : ?><p><a class="button button-primary" href="<?php echo esc_url( AssessCraft_Features::upgrade_url() ); ?>"><?php esc_html_e( 'Unlock JSON import with Pro', 'assesscraft' ); ?></a></p><?php endif; ?>
	...
	private function feature_required( string $feature ): void {
		...
		wp_die(
			wp_kses_post( sprintf( __( 'This feature requires AssessCraft Pro. <a href="%s">View upgrade options</a>.', 'assesscraft' ), esc_url( AssessCraft_Features::upgrade_url() ) ) ),
