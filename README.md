...
> **Current status:** Early development. The core builder, runner, scoring, profiles, configurable reports, and opt-in lead workflow are implemented; templates and publishing integrations remain in development.
